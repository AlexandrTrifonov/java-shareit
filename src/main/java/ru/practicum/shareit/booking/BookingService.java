...
public interface BookingService {
    ...
    List<BookingDto> findAllBookings(Long userId, String state, int from, int size);

    List<BookingDto> findAllBookingsOwner(Long userId, String state, int from, int size);
}
